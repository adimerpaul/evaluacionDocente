<template>
  ...
  >
    <q-list bordered class="rounded-borders">
      ...
      <q-expansion-item dense exact expand-separator icon="analytics" label="Estadistico" to="/estadistico" expand-icon="null" v-if="store.boolasig"/>
      <q-expansion-item dense exact expand-separator icon="print" label="Impresion" to="/asignacion" expand-icon="null" v-if="store.boolasig"/>
